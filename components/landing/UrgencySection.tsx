      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          <div className="lg:w-1/4 space-y-6">
            <h2 className="text-2xl lg:text-3xl xl:text-3xl font-serif font-light tracking-tight text-white">
              Por que essa mudança é inadiável em 2025?
            </h2>
            <p className="text-lg lg:text-3X1 text-gray-300">
          ...
          <div className="lg:w-3/4 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-xl border border-[#F4CE71] p-6 text-left">
                ...
                <h3 className="text-1xl font-bold bg-gradient-to-b from-[#F4CE71] to-[#BE8C38] bg-clip-text text-transparent mb-3">CAC Disparou</h3>
              ...
              <div className="rounded-xl border border-[#F4CE71] p-6 text-left">
                ...
                <h3 className="text-1xl font-bold bg-gradient-to-b from-[#F4CE71] to-[#BE8C38] bg-clip-text text-transparent mb-3">Concorrência Brutal</h3>
                <p className="text-sm text-gray-300 leading-relaxed">
              ...
              <div className="rounded-xl border border-[#F4CE71] p-6 text-left">
                <span className="text-4xl mb-4 block bg-gradient-to-b from-[#F4CE71] to-[#BE8C38] bg-clip-text text-transparent" aria-hidden>🤝</span>
                <h3 className="text-1xl font-bold bg-gradient-to-b from-[#F4CE71] to-[#BE8C38] bg-clip-text text-transparent mb-3">Consumidores Céticos</h3>
                <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="rounded-xl bg-[#BE8C38] px-8 py-5 text-center">
              <p className="text-xl lg:text-1xl font-semibold text-black">
